...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      ...
      <a class="nav-item nav-link text-white" href="index.php?lien=login">Login</a>
      <a class="nav-item nav-link text-white" href="index.php?lien=inscription">Inscription</a>
    </div>
  </div>
</nav>

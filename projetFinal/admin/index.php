...
if (!$_SESSION["idadmin"] and !$_SESSION["password"]) {
...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      ...
      <a class="nav-item nav-link text-white" href="index.php?lien=clients">Clients</a>
      <a class="nav-item nav-link text-white" href="index.php?lien=marchandises">Marchandises</a>
      <a class="nav-item nav-link text-white" href="index.php?lien=ventes">Ventes</a>
      <a class="nav-item nav-link text-white" href="index.php?lien=facture">Facture</a>
